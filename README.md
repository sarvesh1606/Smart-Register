# Smart-Register
Flexible python code for sign up and login page with the features like email confirmation and all basic validations. All the user data is serialized with REST APIs. It can be deployed on any web application.
